...
1.  **Conversão de Cores:** Fórmulas manuais de RGB para Escala de Cinza e RGB para HSV.
...
3.  **Detecção de Bordas:** Utilização do **Gradiente Morfológico** (Diferença entre Dilatação e Erosão).
...
Foram utilizadas ** imagens** de teste variadas, contendo diferentes configurações de bolas, iluminação e ângulos. O algoritmo foi validado processando este lote completo para garantir robustez.
...
[🚀 Acessar Código Fonte](./código.py)
...
1.  **Overlay Gráfico:** Círculos desenhados sobre as bolas (Ciano para Brancas, Preto para Vermelhas).
